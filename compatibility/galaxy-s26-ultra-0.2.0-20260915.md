...
The private ELO evidence retains the exact source-bootstrap harness, operation log, manual renderings, shell probe and fixture-preservation comparisons. This public report includes no secrets, user account data, private filesystem paths or raw conversations. It applies only to the stated device/software configuration and named exercises.
